        ...
        return (
          <div
            ...
            className={cn(
              ...
              isSelected
                ? 'border-emerald-500 shadow-emerald scale-105'
                : 'border-white/10 hover:border-emerald-500/30 hover:-translate-y-1',
              isRecommended && !isSelected && 'border-cyan-500/50'
            )}
          ...
          >
            ...
            {tier.badge && (
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
                <span className="px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wide bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-lg">
                  {tier.badge}
                </span>
              </div>
            )}
            ...
            {isRecommended && (
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-transparent rounded-xl pointer-events-none" />
            )}
          </div>
        );
      })}
