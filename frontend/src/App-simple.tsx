    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6">
        ...
        <form className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-accent-600 text-white py-2 px-4 rounded-md hover:bg-accent-700 focus:outline-none focus:ring-2 focus:ring-accent-500"
          >
            Sign In
          </button>
        </form>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <button className="bg-accent-600 text-white px-4 py-2 rounded-md hover:bg-accent-700">
              Analyze Competitors
            </button>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
