  ...
  "rounded-lg border text-card-foreground shadow-md transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        interactive: "border-white/10 bg-gradient-to-br from-slate-850 to-slate-900 cursor-pointer hover:border-emerald-500/30 hover:-translate-y-1 hover:shadow-emerald",
