  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-white/10 bg-card-dark/50 backdrop-blur-sm px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/menu-comparison" className="flex items-center gap-2">
